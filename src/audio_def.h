...
static const XA_TrackDef xa_tracks[] = {
	...
	//WEEK1B.XA
	{XA_Week1B, XA_LENGTH(6600)}, //XA_Dadbattle
	{XA_Week1B, XA_LENGTH(6800)}, //XA_Tutorial
	//WEEK2A.XA
	{XA_Week2A, XA_LENGTH(8300)}, //XA_Spookeez
	{XA_Week2A, XA_LENGTH(12400)}, //XA_South
	//WEEK2B.XA
	{XA_Week2B, XA_LENGTH(8000)}, //XA_Monster
	{XA_Week2B, XA_LENGTH(11000)}, //XA_Clucked
	//WEEK3A.XA
	{XA_Week3A, XA_LENGTH(45350)},  //XA_Pico
	{XA_Week3A, XA_LENGTH(6600)}, //XA_Philly
};
