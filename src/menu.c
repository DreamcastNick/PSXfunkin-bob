...
static const char *funny_messages[][2] = {
	...
	{"BOB PORT BY GTHREEYT", "DREAMCASTNICK AND UNSTOPABLE"},
};
		...
		case MenuPage_Opening:
		{
			...
			else
			{
				...
				//Fallthrough
					case 2:
					case 1:
						menu.font_bold.draw(&menu.font_bold, "A BUNCH OF IDOTS",   SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						break;
					
					case 7:
						menu.font_bold.draw(&menu.font_bold, "BOB",    SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
				...
				//Fallthrough
					...
					case 15:
						menu.font_bold.draw(&menu.font_bold, "EVER PSX", SCREEN_WIDTH2, SCREEN_HEIGHT2 + 8, FontAlign_Center);
				//Fallthrough
					case 14:
						menu.font_bold.draw(&menu.font_bold, "EVERY FNF MOD", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 8, FontAlign_Center);
				//Fallthrough
					case 13:
						menu.font_bold.draw(&menu.font_bold, "LITERALLY", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 24, FontAlign_Center);
						break;
				}
				break;
			}
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "BOB", {"SUNSHINE", "WITHERED", "RUN"}},
				{NULL, StageId_2_1, "BOB", {"RON", "TROUBLE", "ONSLAUGHT"}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				//{StageId_4_4, "TEST"},
				{StageId_1_1, "SUNSHINE"},
				{StageId_1_2, "WITHERED"},
				{StageId_1_3, "RUN"},
				{StageId_2_1, "RON"},
				{StageId_2_2, "TROUBLE"},
				{StageId_2_3, "ONSLAUGHT"},
				{StageId_3_1, "LITTLE MAN"},
				{StageId_3_2, "RUN REMIX"},
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Clwn_2, "OG BOB MOD", false},
				{StageId_Clwn_2, "PHLOX", false},
				{StageId_Clwn_2, "WILDY", false},
				{StageId_Clwn_2, "DONNEY", false},
				{StageId_Clwn_2, "AYETSG", false},
				{StageId_Clwn_2, "ZEEXEL", false},
				{StageId_Clwn_2, "KYLEGFX", false},
				{StageId_Clwn_2, "MY DAD", false},
				{StageId_Kapi_1, "PORT PROGRAMMING", false},
				{StageId_Kapi_2, "DREAMCASTNICK", false},				
				{StageId_Clwn_1, "MENUS", false},
				{StageId_Clwn_2, "UNSTOPABLE", false},
				{StageId_Clwn_2, "ZERIBEN", false},
				{StageId_Clwn_1, "FNF PSX PORT", false},
				{StageId_Kapi_2, "CUCKYDEV", false},	
				{StageId_Clwn_1, "SPRITES AND IMAGES", false},
				{StageId_Clwn_1, "GTHREEYT", false},
				{StageId_Clwn_1, "DREAMCASTNICK", false},
				{StageId_Clwn_1, "UNSTOPABLE", false},
				{StageId_Clwn_1, "AND OF COURSE YOU FOR PLAYING", false},
			};
