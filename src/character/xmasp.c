...
static const CharFrame char_xmasp_frame[] = {
	{XmasP_ArcMain_Idle0, {0,   0, 128, 234}, { 65, 230}}, //0 idle 1
	{XmasP_ArcMain_Idle1, {0,   0, 128, 234}, { 65, 230}}, //1 idle 2
	{XmasP_ArcMain_Idle2, {0,   0, 128, 234}, { 65, 230}}, //2 idle 3
	{XmasP_ArcMain_Idle3, {0,   0, 128, 324}, { 65, 230}}, //3 idle 4

	{XmasP_ArcMain_LeftA0, {0,   0, 136, 234}, { 65, 230}}, //4 left a 1
	{XmasP_ArcMain_LeftA1, {0,   0, 148, 234}, { 65, 230}}, //5 left a 2
	{XmasP_ArcMain_LeftB0, {0,   0, 148, 234}, { 65, 230}}, //6 left b 1
	{XmasP_ArcMain_LeftB1, {0,   0, 144, 234}, { 65, 230}}, //7 left b 2
	
	{XmasP_ArcMain_DownA0, {0,   0, 128, 234}, { 65, 230}}, //8 down a 1
	{XmasP_ArcMain_DownA1, {0,   0, 128, 234}, { 65, 230}}, //9 down a 2
	{XmasP_ArcMain_DownB0, {0,   0, 148, 234}, { 65, 230}}, //10 down b 1
	{XmasP_ArcMain_DownB1, {0,   0, 144, 234}, { 65, 230}}, //11 down b 2
	
	{XmasP_ArcMain_UpA0, {0,   0, 160, 234}, { 65, 230}}, //12 up a 1
	{XmasP_ArcMain_UpA1, {0,   0, 160, 234}, { 65, 230}}, //13 up a 2
	{XmasP_ArcMain_UpB0, {0,   0, 148, 234}, { 65, 230}}, //14 up b 1
	{XmasP_ArcMain_UpB1, {0,   0, 144, 234}, { 65, 230}}, //15 up b 2
	
	{XmasP_ArcMain_RightA0, {0,   0, 146, 234}, { 65, 230}}, //16 right a 1
	{XmasP_ArcMain_RightA1, {0,   0, 138, 234}, { 65, 230}}, //17 right a 2
	{XmasP_ArcMain_RightB0, {0,   0, 148, 234}, { 65, 230}}, //18 right b 1
	{XmasP_ArcMain_RightB1, {0,   0, 144, 234}, { 65, 230}}, //19 right b 2
};
