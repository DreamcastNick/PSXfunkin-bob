...
static const CharFrame char_gfweeb_frame[] = {
	{GFWeeb_ArcMain_BopLeft, {  0,   0, 104, 97}, { 32,  70}}, //0 bop left 1
	{GFWeeb_ArcMain_BopLeft, {120,   0,  98, 97}, { 32,  70}}, //1 bop left 2
	{GFWeeb_ArcMain_BopLeft, {  0,  98,  98, 96}, { 32,  70}}, //2 bop left 3
	{GFWeeb_ArcMain_BopLeft, {120, 100, 103, 95}, { 32,  70}}, //3 bop left 4
	
	{GFWeeb_ArcMain_BopRight, {  0,   0,  98, 95}, { 32,  70}}, //4 bop right 5
	{GFWeeb_ArcMain_BopRight, {122,   0, 104, 95}, { 32,  70}}, //5 bop right 6
	{GFWeeb_ArcMain_BopRight, {  0,  99,  98, 96}, { 32,  70}}, //6 bop right 7
	{GFWeeb_ArcMain_BopRight, {120,  99, 103, 96}, { 32,  70}}, //7 bop right 8
	
	{GFWeeb_ArcMain_Cry, {  0,   0,  104, 94}, { 32,  70}}, //8 cry
};

static const Animation char_gfweeb_anim[CharAnim_Max] = {
	{0, (const u8[]) { ASCR_CHGANI, CharAnim_Left }},                                  //CharAnim_Idle
	{1, (const u8[]) { 0,  0,  1,  1,  2,  2,  3,  2,  2,  1,  1,  0, ASCR_BACK, 1 }}, //CharAnim_Left
	{0, (const u8[]) { ASCR_CHGANI, CharAnim_Left }},                                  //CharAnim_LeftAlt
	{2, (const u8[]) { 8, ASCR_REPEAT }},                                              //CharAnim_Down
	...
	{1, (const u8[]) { 4,  4,  5,  5,  6,  6,  7,  6,  6,  5,  5,  4, ASCR_BACK, 1 }}, //CharAnim_Right
